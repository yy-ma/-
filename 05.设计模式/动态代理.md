...
​		其实在使用动态代理的时候最最核心的就是Proxy.newProxyInstance(loader, interfaces, h);
...
import com.magicsky.Calculator;
import java.lang.reflect.InvocationHandler;
import java.lang.reflect.Method;
import java.lang.reflect.Proxy;
...
public final class $Proxy0 extends Proxy implements Calculator {
    ...
    static {
        try {
            ...
            m3 = Class.forName("com.magicsky.Calculator").getMethod("add", Integer.TYPE, Integer.TYPE);
            m4 = Class.forName("com.magicsky.Calculator").getMethod("sub", Integer.TYPE, Integer.TYPE);
            m5 = Class.forName("com.magicsky.Calculator").getMethod("mult", Integer.TYPE, Integer.TYPE);
            m6 = Class.forName("com.magicsky.Calculator").getMethod("div", Integer.TYPE, Integer.TYPE);
