...
> Spring中非常重要的一个特性就是IOC,下面我们将要来看一下如何使用IOC容器，帮助大家更好的体会spring的优势。
<!-- more -->

### 1、spring_helloworld

##### **(1)使用手动加载jar包的方式实现，分为三个步骤**
...
- **写配置**
  ...
  <beans xmlns="http://www.springframework.org/schema/beans"
      ...
      class:注册对象的完全限定名
      -->
      <bean id="person" class="com.magicsky.bean.Person">
...
import com.magicsky.bean.Person;
...
```xml
	<!--给person类添加构造方法-->
	<bean id="person2" class="com.magicsky.bean.Person">
	...
	<bean id="person3" class="com.magicsky.bean.Person">
    ...
    <bean id="person4" class="com.magicsky.bean.Person">
	...
	<bean id="person5" class="com.magicsky.bean.Person">
        <constructor-arg value="1"></constructor-arg>
        <constructor-arg value="lisi"></constructor-arg>
...
```xml
    <bean id="person6" class="com.magicsky.bean.Person" p:id="3" p:name="wangwu" p:age="22" p:gender="男"></bean>
```
...
>
    ...
    <bean id="person" class="com.magicsky.bean.Person">
       ...
       <!-- <property name="address">
            <bean class="com.magicsky.bean.Address">
        ...
        <property name="books">
            <list>
                <!--内部bean-->
                <bean id="book1" class="com.magicsky.bean.Book">
    ...
    <bean id="address" class="com.magicsky.bean.Address">
        <property name="province" value="河北"></property>
        <property name="city" value="邯郸"></property>
        <property name="town" value="武安"></property>
    </bean>
    <bean id="book2" class="com.magicsky.bean.Book">
    ...
    <util:map id="myMap">
            ...
            <entry key="key03">
                <bean class="com.magicsky.bean.Book">
...
```xml
    ...
    <bean id="person2" class="com.magicsky.bean.Person" parent="person">
...
```xml
 	<bean id="person" class="com.magicsky.bean.Person" abstract="true">
        <property name="id" value="1"></property>
        <property name="name" value="zhangsan"></property>
        <property name="age" value="21"></property>
        <property name="gender" value="男"></property>
...
```xml
	<bean id="book" class="com.magicsky.bean.Book" depends-on="person,address"></bean>
    <bean id="address" class="com.magicsky.bean.Address"></bean>
    <bean id="person" class="com.magicsky.bean.Person"></bean>
```
...
```xml
    ...
    singleton：默认的单例对象
        ...
        获取的所有对象都是同一个
    -->
    <bean id="person4" class="com.magicsky.bean.Person" scope="prototype"></bean>
```
...
-->
<bean id="person5" class="com.magicsky.factory.PersonStaticFactory" factory-method="getPerson">
...
```xml
    <!--实例工厂使用-->
    <!--创建实例工厂类-->
    <bean id="personInstanceFactory" class="com.magicsky.factory.PersonInstanceFactory"></bean>
    <!--
    factory-bean:指定使用哪个工厂实例
    factory-method:指定使用哪个工厂实例的方法
    -->
    <bean id="person6" class="com.magicsky.bean.Person" factory-bean="personInstanceFactory" factory-method="getPerson">
...
```xml
<bean id="myfactorybean" class="com.magicsky.factory.MyFactoryBean"></bean>
```
...
<!--bean生命周期表示bean的创建到销毁
    ...
    -->
    <bean id="address" class="com.magicsky.bean.Address" init-method="init" destroy-method="destory"></bean>
```

MyTest.java

```java
import com.magicsky.bean.Address;
import org.springframework.context.ApplicationContext;
import org.springframework.context.support.ClassPathXmlApplicationContext;
...
```xml
<bean id="myBeanPostProcessor" class="com.magicsky.bean.MyBeanPostProcessor"></bean>
```
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="person" class="com.magicsky.bean.Person" autowire="byName"></bean>
    <bean id="person2" class="com.magicsky.bean.Person" autowire="byType"></bean>
    <bean id="person3" class="com.magicsky.bean.Person" autowire="constructor"></bean>
</beans>
```
